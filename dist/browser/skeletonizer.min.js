...
return this._simplifyHierarchy(h, t.angle);
}),
(u.prototype._simplifyHierarchy = function(t, i) {
for (
var e = function(t, h) {
for (
var o = new f(),
...
var y = s.getNeighbors().keys();
(g = s),
(s = s.getNeighbors().get(y.next().value)) === t &&
(s = g.getNeighbors().get(y.next().value));
u < 3 && ((r.x += s.getPosition().x), (r.y += s.getPosition().y)),
2 === u &&
((r.x = (r.x - 3 * t.getPosition().x) / 3),
(r.y = (r.y - 3 * t.getPosition().y) / 3)),
u++,
o.subPoints(s.getPosition(), t.getPosition());
var c = o.angle() - r.angle();
Math.abs(c) < i || u < 3
? (t.removeNeighbor(g), s.removeNeighbor(g), t.addNeighbor(s))
: (d = !1),
(n[g.getKey()] = !0),
(a = s.getNeighbors().size);
}
if (!n[s.getKey()])
if (1 === a)
d || (g && g.removeNeighbor(s)),
0 === u && t.removeNeighbor(s),
(n[s.getKey()] = !0);
else if (2 === a) e(g, s), (n[g.getKey()] = !0);
else {
var l = [];
if (
(s.getNeighbors().forEach(function(i, e, h) {
i !== g && i !== t && l.push(i);
}),
!d)
) {
g.removeNeighbor(s);
for (var p = 0; p < l.length; ++p) s.removeNeighbor[l[p]], g.addNeighbor[l[p]];
s = g;
}
n[s.getKey()] = !0;
var w = new Map();
for (p = 0; p < l.length; ++p) {
for (var x = p + 1; x < l.length; ++x) l[p].removeNeighbor(l[x]);
l[p].getNeighbors().forEach(function(t, i, e) {
w.set(i, t);
});
}
w.delete(s.getKey());
var I = new f();
w.forEach(function(t, i, e) {
for (var h = 0, o = 0; o < l.length; ++o) t.hasNeighbor(l[o]) && h++;
if (h > 1)
for (o = 0; o < l.length; ++o)
t.hasNeighbor(l[o]) &&
(I.subPoints(t.getPosition(), l[o].getPosition()),
I.length() > 1 && t.removeNeighbor(l[o]));
});
for (p = 0; p < l.length; ++p) e(s, l[p]);
}
},
h = 0;
h < t.length;
...
if (o.getNeighbors().size > 1) throw "Hoho... Should not happen";
e(
o,
o.getNeighbors().get(
o
...
(m.SkeletonImage = n),
(m.Skeletonizer = p),
(m.skeletonize = function(t, e) {
var o = new i(t),
s = new h(3, 4, o, 0),
r = new n(o, 0, 2e3, s);
return {
skeleton: new p(r, s).buildHierarchy({angle: e || void 0}),
binaryImg: o,
distImg: s,
skelImg: r
};
